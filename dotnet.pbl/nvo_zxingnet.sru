forward
global type nvo_zxingnet from dotnetobject
end type
end forward
...
global nvo_zxingnet nvo_zxingnet

type variables

PUBLIC:
String is_assemblypath = "DotNet\ZxingBarcode\ZxingBarcode.dll"
String is_classname = "ZxingBarcode.ZxingNet"
...
on nvo_zxingnet.create
call super::create
TriggerEvent( this, "constructor" )
end on

on nvo_zxingnet.destroy
TriggerEvent( this, "destructor" )
call super::destroy
end on

event constructor;is_assemblypath = gs_appdir + "DotNet\ZxingBarcode\ZxingBarcode.dll"
end event
